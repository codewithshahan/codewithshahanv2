      ...
      try {
        ...
        setCategories([
          ...
          },
          {
            ...
            slug: "tips",
            icon: Lightbulb,
            description: "Helpful programming tips and tricks",
            color: "#FFCC00",
          },
          {
            name: "Architecture",
            slug: "architecture",
            icon: Blocks,
            description: "Software architecture patterns and practices",
            color: "#5856D6",
          },
        ]);
      } finally {
  ...
  const getIconScale = useCallback(
    (index: number): number => {
      ...
      const itemDimension = isVertical
        ? dockDimensions.height / categoryCount
        : dockDimensions.width / categoryCount;
  ...
  if (isFetchingCategories) {
    return (
      <div className="flex justify-center">
        <div
          className={cn(
            "fixed backdrop-blur-lg animate-pulse",
            isMobile
              ? "bottom-8 h-16 md:h-20 w-64 rounded-full bg-gray-900/20"
              : "right-8 top-1/2 -translate-y-1/2 w-20 h-[400px] rounded-full bg-gray-900/20"
          )}
        ></div>
      </div>
    );
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <motion.div
        ref={dockRef}
        className={cn(
          "fixed z-50 flex justify-center px-4 py-4 rounded-full",
          isMobile
            ? "bottom-8 flex-row"
      ...
      >
        ...
        <div
          className={cn(
            "flex items-center",
            isMobile ? "gap-1 md:gap-3" : "flex-col gap-3"
          )}
        >
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  animate={{
                    scale: iconScale,
                    y: isMobile && hoveredIndex === index ? -15 : 0,
                    x: !isMobile && hoveredIndex === index ? -15 : 0,
                  }}
                  transition={{
                    type: "spring",
                    stiffness: 400,
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      className={cn(
                        "absolute w-1.5 h-1.5 rounded-full bg-white shadow-[0_0_5px_rgba(255,255,255,0.5)]",
                  ...
                  <motion.div
                    className={cn(
                      ...
                      isMobile ? "-bottom-5 w-10 h-1.5" : "-right-5 h-10 w-1.5"
                    )}
                    style={{
                      scale: iconScale,
                ...
                <AnimatePresence>
                  {hoveredIndex === index && (
                    <motion.div
                      className={cn(
                        "absolute w-[350px] rounded-xl overflow-hidden z-50",
                        isMobile
                          ? "bottom-full left-1/2 -translate-x-1/2 mb-14"
                          : "top-1/2 -left-[370px] -translate-y-1/2",
                        isDark
        ...
        <div
          className={cn(
            ...
            isMobile
              ? "left-5 right-5 h-[1px] bottom-0"
              : "top-5 bottom-5 w-[1px] right-0"
          )}
        />
        ...
        {isMobile ? (
          ...
          <>
            <div className="absolute inset-y-0 w-1/2 right-0 bg-gradient-to-l from-black/5 to-transparent rounded-r-full pointer-events-none" />
            <div className="absolute inset-y-0 w-1/3 left-0 bg-gradient-to-r from-white/10 to-transparent rounded-l-full pointer-events-none" />
          </>
        )}
      </motion.div>
    </div>
