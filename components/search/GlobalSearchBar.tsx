...
const sampleSearchResults: SearchResult[] = [
  {
    ...
    excerpt:
      "Learn how to build scalable and maintainable React applications...",
    type: "article",
    url: "/article/building-modern-react-applications",
    category: "React",
  },
  {
    id: "2",
    title: "CSS Grid Mastery",
    excerpt: "Master the art of CSS Grid layout...",
    type: "article",
    url: "/article/css-grid-mastery",
    category: "CSS",
  },
  {
    id: "3",
    title: "TypeScript for React Developers",
    excerpt: "A comprehensive guide to TypeScript in React...",
    type: "article",
    url: "/article/typescript-for-react-developers",
    category: "TypeScript",
  },
];
